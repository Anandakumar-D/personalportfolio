...
import { Mail, Linkedin, MessageSquare, Send, CheckCircle, AlertCircle } from 'lucide-react';
...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-12 sm:py-16 lg:py-20 bg-slate-50 dark:bg-slate-800 pb-20 sm:pb-24 lg:pb-28">
          ...
          <div className="grid lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                ...
                {contactMethods.map((method) => {
                  ...
                  return (
                    <a
                      ...
                      className={`group flex items-center p-3 sm:p-4 rounded-xl transition-all duration-300 ${
                        method.primary
                          ? 'bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-800 hover:border-blue-300 dark:hover:border-blue-600'
            ...
            <div className="lg:col-span-3">
              <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-4 sm:p-6 shadow-lg">
                ...
                {status.type === 'success' && (
                  <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center">
                    <CheckCircle size={16} className="text-green-600 dark:text-green-400 mr-2 flex-shrink-0" />
                    <span className="text-green-800 dark:text-green-200 text-xs sm:text-sm">{status.message}</span>
                  </div>
                )}
                ...
                {status.type === 'error' && (
                  <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg flex items-center">
                    ...
                    <span className="text-red-800 dark:text-red-200 text-xs sm:text-sm">{status.message}</span>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 text-slate-900 dark:text-white text-sm"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 text-slate-900 dark:text-white resize-none text-sm"
